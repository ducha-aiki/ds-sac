...
def main():
    ...
    ap.add_argument("--snn", nargs="*", type=float, default=[0.85],
                    help="SNN ratio thresholds to sweep, applied to all "
                         "methods (1.0 = off); unlike the homography archive, "
                         "this data ships unfiltered and raw inlier ratios are "
                         "often below DS-SAC's default p_min floor")
              ...
              for snn in args.snn:
                ...
                for m in args.methods:
                    for th in THRESHOLDS_F:
                        ...
                        try:
                            F, mask = F_METHODS[m](pts1, pts2, th, sc_keep)
